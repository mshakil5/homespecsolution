...
<section class="breadcrumb imageContent mb-0">
    <img src="{{ asset('images/banner/'.\App\Models\Banner::where('name','=', 'commercial')->first()->image) }}" style="width: 100%" class="cover">
...
<section class="border-top  py-0 projects">
    <div class="container px-4 mt-3">
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
            @foreach (\App\Models\Property::where('category_id','=', '3')->limit(9)->get() as $data)
